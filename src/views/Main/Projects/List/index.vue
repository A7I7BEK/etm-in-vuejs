			...
			<base-crud-table>
				...
				<template #head>
					<tr>
						...
						<th class="sort" @click="HandleParams('sort', 'group')" :class="{'active': params.sortBy === 'group'}">
							<div class="az_crud_tb_th">
						...
						<th class="sort" @click="HandleParams('sort', 'managerName')" :class="{'active': params.sortBy === 'managerName'}">
							<div class="az_crud_tb_th">
						...
						<th class="sort" @click="HandleParams('sort', 'percent')" :class="{'active': params.sortBy === 'percent'}">
							<div class="az_crud_tb_th">
						...
						<th class="sort" @click="HandleParams('sort', 'projectType')" :class="{'active': params.sortBy === 'projectType'}">
							<div class="az_crud_tb_th">
				...
				<template #body v-if="record.list.length > 0">
					<tr v-for="(item, index) in record.list">
						...
						<td>
							<div class="az_crud_tb_prgs_bx" v-if="item.projectType.value === $store.state.PROJECT_TYPE_KANBAN">
								<div class="az_crud_tb_prgs_txt">{{ item.percent }}%</div>
								<div class="progress az_crud_tb_prgs"
									 :class="
									 {
							...
							<div class="az_crud_tb_txt" v-else-if="item.projectType.value === $store.state.PROJECT_TYPE_TRELLO">
								{{ $t('notAvailable') }}
							</div>
						</td>
