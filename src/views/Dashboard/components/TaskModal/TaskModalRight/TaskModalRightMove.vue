<template>
	<div class="mw-menu__item mw-moving custom-dropdown__main" data-custom-drop>
			...
			<div class="menu-copy__content">
				<div class="menu-copy__inner">
					...
					<div class="d-flex justify-content-end">
						<button type="button" class="create-card button-effect m-0" @click="TaskChange">{{$t('move')}}</button>
					</div>
