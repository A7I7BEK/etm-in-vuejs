<template>
	<div class="az_action_item">
		<template v-if="activityType === 'CREATE_PROJECT'">
			<i18n
				data-name="CREATE_PROJECT"
				tag="p"
				path="actionItem.CREATE_PROJECT"
			></i18n>
		</template>

		<template v-else-if="activityType === 'DELETE_PROJECT'">
			<i18n
				data-name="DELETE_PROJECT"
				tag="p"
				path="actionItem.DELETE_PROJECT"
			></i18n>
		</template>

		<template v-else-if="activityType === 'CHANGE_PROJECT'">
			<i18n
				data-name="CHANGE_PROJECT"
				tag="p"
				path="actionItem.CHANGE_PROJECT"
			>
		...
		<template v-else-if="activityType === 'INVITE_MEMBER'">
			<i18n
				data-name="INVITE_MEMBER"
				tag="p"
				path="actionItem.INVITE_MEMBER"
			>
		...
		<template v-else-if="activityType === 'REMOVE_MEMBER'">
			<i18n
				data-name="REMOVE_MEMBER"
				tag="p"
				path="actionItem.REMOVE_MEMBER"
			>
		...
		<template v-else-if="activityType === 'ADD_PROJECT_COLUMN'">
			<i18n
				data-name="ADD_PROJECT_COLUMN"
				tag="p"
				path="actionItem.ADD_PROJECT_COLUMN"
			>
		...
		<template v-else-if="activityType === 'UPDATE_PROJECT_COLUMN'">
			<i18n
				data-name="UPDATE_PROJECT_COLUMN"
				tag="p"
				path="actionItem.UPDATE_PROJECT_COLUMN"
			>
		...
		<template v-else-if="activityType === 'DELETED_PROJECT_COLUMN'">
			<i18n
				data-name="DELETED_PROJECT_COLUMN"
				tag="p"
				path="actionItem.DELETED_PROJECT_COLUMN"
			>
		...
		<template v-else-if="activityType === 'UPDATE_TASK'">
			<i18n
				data-name="UPDATE_TASK"
				tag="p"
				path="actionItem.UPDATE_TASK"
			>
			...
			<div>
				...
				<ul>
					...
					<li v-if="textParams.level">
						Level property changed from "{{ textParams.level.oldValue }}" to
						"{{ textParams.level.newValue }}"
					</li>
					<li v-if="textParams.priority">
						Priority property changed from "{{ textParams.priority.oldValue }}" to
						"{{ textParams.priority.newValue }}"
					</li>
				</ul>
			</div>
		</template>
		...
		<template v-else-if="activityType === 'DELETE_TASK'">
			<i18n
				data-name="DELETE_TASK"
				tag="p"
				path="actionItem.DELETE_TASK"
			>
				<template #text>{{ name }}</template>
			</i18n>
		</template>
		...
		<template v-else-if="activityType === 'JOIN_TASK_MEMBER'">
			<i18n
				data-name="JOIN_TASK_MEMBER"
				tag="p"
				path="actionItem.JOIN_TASK_MEMBER"
			>
		...
		<template v-else-if="activityType === 'REMOVE_TASK_MEMBER'">
			<i18n
				data-name="REMOVE_TASK_MEMBER"
				tag="p"
				path="actionItem.REMOVE_TASK_MEMBER"
			>
				<template #removeUser>{{ textParams.memberName }}</template>
				<template #joinTask>
					<a
		...
		<template v-else-if="activityType === 'CREATE_CHECKLIST_GROUP'">
			<i18n
				data-name="CREATE_CHECKLIST_GROUP"
				tag="p"
				path="actionItem.CREATE_CHECKLIST_GROUP"
			>
		...
		<template v-else-if="activityType === 'DELETE_CHECKLIST_GROUP'">
			<i18n
				data-name="DELETE_CHECKLIST_GROUP"
				tag="p"
				path="actionItem.DELETE_CHECKLIST_GROUP"
			>
		...
		<template v-else-if="activityType === 'CREATE_CHECKLIST_ITEM'">
			<i18n
				data-name="CREATE_CHECKLIST_ITEM"
				tag="p"
				path="actionItem.CREATE_CHECKLIST_ITEM"
			>
		...
		<template v-else-if="activityType === 'DELETE_CHECKLIST_ITEM'">
			<i18n
				data-name="DELETE_CHECKLIST_ITEM"
				tag="p"
				path="actionItem.DELETE_CHECKLIST_ITEM"
			>
		...
		<template v-else-if="activityType === 'COMPLETE_CHECKLIST_ITEM'">
			<i18n
				data-name="COMPLETE_CHECKLIST_ITEM"
				tag="p"
				path="actionItem.COMPLETE_CHECKLIST_ITEM"
			>
				<template #checkListText>{{ textParams.checkListText }}</template>
				<template #taskName>
					<a
		...
		<template v-else-if="activityType === 'ADD_COMMENT'">
			<i18n
				data-name="ADD_COMMENT"
				tag="p"
				path="actionItem.ADD_COMMENT"
			>
		...
		<template v-else-if="activityType === 'ADD_CHECKLIST'">
			<i18n
				data-name="ADD_CHECKLIST"
				tag="p"
				path="actionItem.ADD_CHECKLIST"
			>
				<template #checkListName>{{ textParams.checkListText }}</template>
				<template #taskName>
					<a
		...
		<template v-else-if="activityType === 'CHANGE_COMMENT'">
			<i18n
				data-name="CHANGE_COMMENT"
				tag="p"
				path="actionItem.CHANGE_COMMENT"
			>
		...
		<template v-else-if="activityType === 'DELETE_COMMENT'">
			<i18n
				...
				tag="p"
				path="actionItem.DELETE_COMMENT"
			>
		...
		<template v-else-if="activityType === 'ADD_ATTACHMENT'">
			<i18n
				data-name="ADD_ATTACHMENT"
				tag="p"
				path="actionItem.ADD_ATTACHMENT"
			>
		...
		<template v-else-if="activityType === 'DELETE_ATTACHMENT'">
			<i18n
				data-name="DELETE_ATTACHMENT"
				tag="p"
				path="actionItem.DELETE_ATTACHMENT"
			>
		...
		<template v-else-if="activityType === 'ADD_DUE_DATE'">
			<i18n
				data-name="ADD_DUE_DATE"
				tag="p"
				path="actionItem.ADD_DUE_DATE"
			>
		...
		<template v-else-if="activityType === 'UPDATE_CHECKLIST_ITEM'">
			<i18n
				data-name="UPDATE_CHECKLIST_ITEM"
				tag="p"
				path="actionItem.UPDATE_CHECKLIST_ITEM"
			>
		...
		<template v-else-if="activityType === 'UPDATE_CHECKLIST_GROUP'">
			<i18n
				data-name="UPDATE_CHECKLIST_GROUP"
				tag="p"
				path="actionItem.UPDATE_CHECKLIST_GROUP"
			>
