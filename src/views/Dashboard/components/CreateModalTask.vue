<template>
	<div class="modal fade modal_task" id="modalCreateTask">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form @submit.prevent="CreateTask" id="taskCreateForm">
						<div>
				...
				<div class="d-flex justify-content-between p-3">
					...
					<button class="btn az_base_btn btn-primary button-effect" form="taskCreateForm" type="submit">{{$t('save')}}</button>
				</div>
			</div>
		</div>
	</div>
