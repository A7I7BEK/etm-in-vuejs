<template>
	<div class="modal fade modal_column" id="modalCreateColumn">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form @submit.prevent="CreateColumn" id="columnCreateForm">
						<div>
				...
				<div class="d-flex justify-content-between p-3">
					<button class="btn az_base_btn btn-default button-effect" type="button" data-dismiss="modal">{{$t('cancel')}}</button>
					<button class="btn az_base_btn btn-primary button-effect" form="columnCreateForm" type="submit">{{$t('save')}}</button>
				</div>
			</div>
		</div>
	</div>
